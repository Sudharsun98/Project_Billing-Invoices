...
const InvoiceSchema = new mongoose.Schema({
    ...
    paymentType: { type: String, trim: true, default: 'N/A' },
...
app.post('/api/invoices', async (req, res) => {
    try {
        ...
        const doc = new Invoice({
            invoiceId,
            orderType: payload.orderType || 'N/A',     // ✅ Default to 'N/A'
            paymentType: payload.paymentType || 'N/A', // ✅ Default to 'N/A'
            date: payload.date ? new Date(payload.date) : new Date(),
            customerName: payload.customerName || 'NA',
            customerPhone: payload.customerPhone || 'NA',
            items,
            total
        });
...
app.post('/api/drafts', async (req, res) => {
    try {
        ...
        if (payload.id) { // This is an update of an existing draft
            ...
            doc.customerPhone = payload.customerPhone;
